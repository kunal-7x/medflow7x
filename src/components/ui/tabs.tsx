...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center gap-1 rounded-xl bg-secondary/50 p-1 text-muted-foreground border border-border/30",
      className
    )}
    {...props}
  />
